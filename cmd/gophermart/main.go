...
// curl -X POST "http://localhost:8080/api/user/balance/withdraw" -H "Authorization: $argon2id$v=19$m=65536,t=1,p=4$HgxM6qkeeZqMtMH8HczRjCi9xR2iYzN7zaLy8uj5xmV/uAbad/c7txUFRYq+Wr32" -H "Content-Type: application/json" -d "{\"order\": \"4561261212345467\", \"sum\": 100}"
// 4561261212345464
// 12345678903
